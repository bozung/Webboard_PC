...
<table style="border: 2px solid black; width: 40%" align="center">
    ...
    <tr><td>ชื่อบัญชี :</td><td><input type="text" name="newuser" size="40" required></td></tr>
    <tr><td>รหัสผ่าน :</td><td><input type="password" name="newpwd" size="40" required></td></tr>
    <tr><td>ชื่อ-นามสกุล :</td><td><input type="text" name="newname" size="40" required></td></tr>
    <tr><td rowspan="3">เพศ :</td><td><input type="radio" name="man">ชาย</td></tr>
    <tr><td><input type="radio" name="woman">หญิง</td></tr>
    <tr><td><input type="radio" name="LGBTQ+">อื่นๆ</td></tr>
